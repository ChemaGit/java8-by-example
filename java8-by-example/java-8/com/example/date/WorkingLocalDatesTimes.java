...
public class WorkingLocalDatesTimes {
	...
	public static void main(String[] args) {
		...
		LocalDate nowBennedict = LocalDate.now();
		System.out.println("Bennedict is " + bennedict.until(nowBennedict, DECADES) + " decades old.");
		System.out.println("It was a " + bennedict.plusYears(21).getDayOfWeek() + " on his 21st.");
		System.out.println("");
		...
		System.out.println("Schools starts: " + schoolStarts);
		...
		System.out.println("");
		//A meeting is scheduled for 1:30 PM next Tuesday. 
		//If today is Tuesday, assume it is today.
